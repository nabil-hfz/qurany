...
interceptors_1.interceptors.forEach((interceptor) => {
    app.use(interceptor);
});
const httpServer = new controllers_1.HttpServer(app);
controllers_2.CONTROLLERS.forEach((controller) => {
...
app.listen(PORT, () => {
    (0, logger_1.log)(`Server listening on port http://localhost:${PORT}...`);
});
